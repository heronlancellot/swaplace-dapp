// TODO: Check this queries to handle marketplace
...
export const ALL_OFFERS_MARKETPLACE_QUERY = `
         query swapDatabases($orderBy: String!, $orderDirection: String!, $inputAddress: String, $after: String, $allowed: String) {
          swapDatabases(
             ...
             where: {allowed: 0x0000000000000000000000000000000000000000},
             limit: 20,
             after: $after
           ) {
             items {
...
export const CREATED_OFFERS_MARKETPLACE_QUERY = `
...
export const RECEIVED_OFFERS_MARKETPLACE_QUERY = `
...
export const ACCEPTED_OFFERS_MARKETPLACE_QUERY = `
         query swapDatabases($orderBy: String!, $orderDirection: String!, $inputAddress: String, $after: String, $allowed: String) {
          swapDatabases(
             orderBy: $orderBy,
             orderDirection: $orderDirection,
...
export const CANCELED_OFFERS_MARKETPLACE_QUERY = `
         query swapDatabases($orderBy: String!, $orderDirection: String!, $inputAddress: String, $after: String, $allowed: String) {
          swapDatabases(
             orderBy: $orderBy,
             orderDirection: $orderDirection,
...
export const EXPIRED_OFFERS_MARKETPLACE_QUERY = `
