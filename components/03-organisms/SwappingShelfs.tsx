...
export const SwappingShelfs = () => {
  ...
  return (
    <div className="w-full h-full dark:bg-midnightGreen dark:border-darkGray border border-softGray rounded-2xl dark:shadow-swap-station shadow-swap-station-light">
