    ...
    <div className="flex">
      <input
        ...
        className={cc([
          ...
          "bg-offWhite borderlightSilver hover:border-limeYellow hover:shadow-[0_0_6px_1px_#00000014] focus:shadow-[0_0_6px_1px_#00000014] focus:border-opacity-100 dark:bg-darkGreen dark:border-darkGray dark:hover:border-softLemon dark:hover:dark:shadow-[0_0_6px_1px_#00000066] dark:focus:dark:shadow-[0_0_6px_1px_#00000066]",
        ])}
